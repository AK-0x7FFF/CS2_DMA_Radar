...
from .pyMeow import open_process, module_exists, get_module, aob_scan_module, r_bytes
from .structure import StructMeowProcess, StructMeowModule
...
class MeowModule:
    ...
    def __getitem__(self, item: str) -> Any:
        return self.module.get(item, None)
